...
import com.gemtechnologies.modules.module.templates.*
...
class ModuleGenerator(
    ...
    private fun generateManifest() {
        writeTextToFile(File(config.mainFolder, "AndroidManifest.xml"), ManifestTemplate(config).getTemplate(), false)
    }
    ...
    private fun generateGradleFile() {
        writeTextToFile(File(config.rootFolder, "build.gradle"), GradleTemplate(config).getTemplate(), false)
    }
